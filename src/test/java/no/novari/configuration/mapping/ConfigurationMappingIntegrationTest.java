...
import no.novari.configuration.model.configuration.dtos.FromCollectionMappingDto;
...
import no.novari.configuration.mapping.ConfigurationMappingService;
import no.novari.configuration.mapping.InstanceCollectionReferencesMappingService;
import no.novari.configuration.mapping.ObjectCollectionMappingMappingService;
import no.novari.configuration.mapping.ObjectMappingMappingService;
import no.novari.configuration.mapping.ObjectsFromCollectionMappingMappingService;
import no.novari.configuration.mapping.PerKeyMappingService;
import no.novari.configuration.mapping.ValueCollectionMappingMappingService;
import no.novari.configuration.mapping.ValueMappingMappingService;
import no.novari.configuration.mapping.ValuesFromCollectionMappingMappingService;
import no.novari.configuration.model.configuration.entities.collection.InstanceCollectionReference;
import no.novari.configuration.model.configuration.entities.collection.ObjectCollectionMapping;
import no.novari.configuration.model.configuration.entities.collection.ObjectsFromCollectionMapping;
import no.novari.configuration.model.configuration.entities.collection.ValueCollectionMapping;
import no.novari.configuration.model.configuration.entities.collection.ValuesFromCollectionMapping;
