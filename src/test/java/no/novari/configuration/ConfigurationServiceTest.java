...
import no.novari.configuration.ConfigurationFilter;
import no.novari.configuration.ConfigurationRepository;
import no.novari.configuration.ConfigurationService;
import no.novari.configuration.ObjectMappingRepository;
