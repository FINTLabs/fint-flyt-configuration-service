...
public class IntegrationAndMetadataMatchesValidator implements
        HibernateConstraintValidator<IntegrationAndMetadataMatches, Configuration> {

    @Override
    public boolean isValid(Configuration value, HibernateConstraintValidatorContext context) {
