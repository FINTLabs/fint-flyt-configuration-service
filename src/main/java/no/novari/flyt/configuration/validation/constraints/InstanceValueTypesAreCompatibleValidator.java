...
import static no.novari.flyt.configuration.validation.constraints.InstanceValueTypesAreCompatible.CONFIGURATION_VALUE_TYPE;
import static no.novari.flyt.configuration.validation.constraints.InstanceValueTypesAreCompatible.INCOMPATIBLE_INSTANCE_VALUES_KEY_AND_TYPE;
